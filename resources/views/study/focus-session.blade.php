...
<div class="leaf" style="left:30%; animation-duration:14s;">🍃</div>
<div class="leaf" style="left:50%; animation-duration:10s;">🍃</div>
<div class="leaf" style="left:70%; animation-duration:13s;">🍃</div>
<div class="leaf" style="left:90%; animation-duration:11s;">🍃</div>
...
<nav class="flex flex-wrap gap-4 text-sm md:text-base font-medium">
...
<!-- MAIN -->
<div class="max-w-4xl mx-auto px-4 md:px-8 py-10 md:py-16 text-center">

<h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-2">
Focus Session
</h2>

<p class="text-gray-500 mb-8 md:mb-10 text-sm md:text-base">
...
<div class="mt-2 flex flex-col sm:flex-row justify-center gap-3 items-center">
...
class="bg-emerald-500 text-white px-5 py-2 rounded-xl hover:bg-emerald-600 transition">
Set
</button>
...
<div id="timerCircle"
class="w-56 h-56 md:w-72 md:h-72 rounded-full flex items-center justify-center breathing glow">

<div class="w-44 h-44 md:w-56 md:h-56 bg-white rounded-full flex items-center justify-center shadow-inner">

<span id="timer"
class="text-3xl md:text-5xl font-bold text-emerald-600">
00:00
</span>
...
class="bg-emerald-500 text-white px-6 py-3 rounded-xl hover:scale-105 transition shadow">
Start
</button>

<button onclick="pauseTimer()"
class="bg-yellow-400 text-white px-6 py-3 rounded-xl hover:scale-105 transition shadow">
Pause
</button>

<button onclick="resetTimer()"
class="bg-gray-400 text-white px-6 py-3 rounded-xl hover:scale-105 transition shadow">
Reset
</button>
...
<!-- QUOTE -->
<p id="quote"
class="mt-8 text-emerald-700 italic text-sm md:text-lg animate-pulse">
